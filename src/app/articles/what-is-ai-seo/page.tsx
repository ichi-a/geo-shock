...
export const metadata: Metadata = {
  ...
  description:
    "AI SEOとは、AIを活用したSEO効率化と、AI検索（生成AI）に引用されるためのコンテンツ最適化の両方を含む概念。GEO・AEO・AIOとの関係も解説。",
...
export default function WhatIsAiSeoPage() {
  const jsonLd = {
    ...
    description:
      "AI SEOとは、AIを活用したSEO効率化とAI検索への最適化の両方を含む概念。",
    url: PAGE_URL,
    ...
    mainEntity: {
      ...
      name: "AI SEO",
      description:
        "AIを活用したSEO作業の効率化と、AI検索エンジンに引用されるためのコンテンツ最適化の両方を含む概念。",
    },
  };
      ...
      <article style={{ maxWidth: "680px" }}>
        ...
        <div className="definition-box">
          ...
          <p style={{ lineHeight: 1.8 }}>
            ...
            とは、①AIツールを活用してSEO作業を効率化する「AIによるSEO」と、②ChatGPTやPerplexityなどのAI検索エンジンに引用される「AI向けのSEO」の両方を含む概念の総称。広義には
        ...
        <p>
          AI
          SEOという言葉は、文脈によって2つの異なる意味で使われる。この2つを区別して理解することが重要だ。
        </p>
        ...
        >
          ...
          >
            ...
            >
              ...
              OverviewsなどのAI検索に回答の一部として引用されるようコンテンツを最適化する。GEO・AIO・AEOと同義。
            </p>
          </div>
        </div>
        ...
        >
          {[
            ...
            >
              ...
              <p style={{ color: "var(--neutral-800)", lineHeight: 1.65 }}>
                {item}
              </p>
            </div>
          ))}
        ...
        >
          {[
            {
              q: "AI SEOとGEOの違いは何ですか？",
              a: "AI SEOは「AIを使ったSEO」と「AI向けのSEO」の両方を含む広義の概念です。GEOはその中の「生成AIエンジンへの最適化」に特化した概念です。AI SEOはGEO・AIO・AEOを包括する上位概念と捉えることができます。",
            },
            {
              q: "AI SEOを始めるにはどこから手をつければよいですか？",
              a: "まず既存コンテンツへのJSON-LD構造化データの実装と、FAQ形式のコンテンツ追加から始めるのが効率的です。次にAIに直接質問して自社コンテンツが引用されるかを定期観測する習慣をつけましょう。",
            },
          ].map((item) => (
            <div
              key={item.q}
