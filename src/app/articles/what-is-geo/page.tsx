  ...
  const faqJsonLd = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "実質的にほぼ同義です。AEO（Answer Engine Optimization）は回答エンジンへの最適化、AIO（AI Optimization）はAI Overviews対策に焦点を当てた用語ですが、対策内容はGEOと大きく重なります。GEO Findingsでは生成エンジン全般への最適化という意味でGEOという用語を使用しています。",
        },
      },
      {
        "@type": "Question",
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "JSON-LDによる構造化データの実装と、一次情報・独自データを含む明確な記述が最も効果的とされています。GEO Findingsの実験でも、JSON-LDの有無がAIクローラーの来訪頻度に影響することが示唆されています。",
        },
      },
    ],
  };
      ...
      <article style={{ maxWidth: "680px" }}>
        ...
        <div className="definition-box">
          ...
          <p style={{ lineHeight: 1.8 }}>
            ...
            とは、 ChatGPT・Perplexity・Google AI
            OverviewsなどのAIが回答を構成する際に、
        ...
        <h2>なぜGEOが必要か</h2>
        <p>
          ユーザーの情報収集行動が変化している。かつて「Google検索 →
          リンクをクリック →
          サイトで情報を読む」というフローが主流だったが、現在は「AIに質問 →
          AIが直接回答」という形が急速に普及している。
        </p>
        <p>
        ...
        >
          {[
            {
              title: "JSON-LDによる構造化データの実装",
              body: "AIがコンテンツの内容・文脈・著者を正確に理解できるよう、Schema.orgに基づく構造化データを実装する。GEO Findingsの実験では、JSON-LDの有無がAIクローラーの来訪頻度に影響することが示唆されている。",
            },
            {
              title: "結論ファーストの記述構造",
              body: "AIは記事冒頭の情報を回答に組み込みやすい。ページの冒頭で定義・結論を明示し、その後で詳細・根拠を展開するパターンが有効とされる。",
            },
            {
              title: "一次情報・独自データの提供",
              body: "他サイトにない独自の観測データ・実験結果・専門的見解を提供することで、AIにとって「引用する価値がある情報源」として評価される可能性が高まる。",
            },
            {
              title: "FAQPage・DefinedTermスキーマの活用",
              body: "よくある質問と回答を構造化することで、AIが特定の問いに対する答えとして採用しやすくなる。造語の定義にはDefinedTermスキーマが特に有効。",
            },
          ].map((item) => (
            <div
              key={item.title}
        ...
        >
          {[
            {
              q: "GEOとSEOの違いは何ですか？",
              a: "SEOは検索エンジンの順位を上げてクリックを獲得することを目的とします。GEOはAIが生成する回答に引用されることを目的とし、クリックではなく「AIによる言及」を成果指標とします。",
            },
            {
              q: "GEOとAEO・AIOは同じですか？",
              a: "実質的にほぼ同義です。AEO（Answer Engine Optimization）は回答エンジンへの最適化、AIO（AI Optimization）はAI Overviews対策に焦点を当てた用語ですが、対策内容はGEOと大きく重なります。",
            },
            {
              q: "GEO対策で最も効果的なことは何ですか？",
              a: "JSON-LDによる構造化データの実装と、一次情報・独自データを含む明確な記述が最も効果的とされています。GEO Findingsの実験でも、JSON-LDの有無がAIクローラーの来訪頻度に影響することが示唆されています。",
            },
          ].map((item) => (
            <div
              key={item.q}
        ...
        <div className="observing-banner" style={{ marginTop: "1.5rem" }}>
          GEO Findings はこのサイト自体をGEO実験場として運用中。
          <a
            href="/experiments"
            style={{
              color: "#92400E",
        ...
        >
          <p>公開日: 2025-01-01 / 更新日: 2026-02-23 / GEO Findings</p>
          <div
            style={{
              marginTop: "0.5rem",
              display: "flex",
