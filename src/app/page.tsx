...
export default function HomePage() {
  ...
  const experiments = [
    {
      label: "EXP-001",
      title: "JSON-LDの有無によるクロール頻度の差",
      href: "/terms/geo-shock-index-a",
    },
    {
      label: "EXP-002",
      title: "造語「GEOショック指数」のAI反映速度",
      href: "/terms/geo-shock-index-a",
    },
    {
      label: "EXP-003",
      title: "ハニーポットによる無差別クローラー検出",
      href: "/experiments",
    },
  ];
  ...
  const articles = [
    {
      ...
      label: "GEO特化型",
      desc: "JSON-LDあり・結論ファースト",
    },
    {
      href: "/articles/why-jsonld-matters",
      title: "JSON-LDはGEOに効くのか",
      label: "GEO特化型",
      desc: "FAQPage Schema使用",
    },
    {
      href: "/articles/ai-and-content-creators",
      title: "AIはコンテンツを盗んでいるのか",
      label: "人間向けデコイ",
      desc: "感情型・JSON-LDなし",
    },
  ];
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "3rem" }}>
      ...
      >
        ...
        <div style={{ display: "flex", gap: "0.75rem", flexWrap: "wrap" }}>
          <a href="/articles/what-is-geo" className="btn btn-primary">
            GEOとは何か →
          </a>
          <a href="/experiments" className="btn btn-outline">
            実験ログを見る →
          </a>
          <a href="/stats" className="btn btn-outline">
            リアルタイム クローラー ログ →
          </a>
        </div>
      </section>
      ...
      <section>
        ...
        >
          {articles.map((article) => (
            ...
            >
              <span
                className={`badge ${article.label === "人間向けデコイ" ? "badge-orange" : "badge-primary"}`}
                style={{ flexShrink: 0 }}
              >
                {article.label}
              </span>
