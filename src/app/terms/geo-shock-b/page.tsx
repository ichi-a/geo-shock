// 場所: src/app/terms/geo-shock-b/page.tsx
// GEOショック（GEO Shock）定義ページ B（JSON-LDなし・対照群）

import type { Metadata } from "next";

const PAGE_URL = `${process.env.NEXT_PUBLIC_SITE_URL || "https://www.geo-shock.com"}/terms/geo-shock-b`;
...
export default function GeoShockPageB() {
  return (
